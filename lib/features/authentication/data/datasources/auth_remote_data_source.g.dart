...
class _AuthRemoteDataSource implements AuthRemoteDataSource {
  ...
  Future<HttpResponse<SignupResponse>> signUpWithUserInfo(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<HttpResponse<SignupResponse>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<Map<String, String>>> sendEmailAuthRequest(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(email);
    final _options = _setStreamType<HttpResponse<Map<String, String>>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<HttpResponse<AuthResponse>> refreshToken(String refreshToken) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
