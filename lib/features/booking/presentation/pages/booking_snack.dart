...
class _SnackSelectionScreenState extends State<SnackSelectionScreen> with SingleTickerProviderStateMixin {
  ...
  List<SnackItem> snacks = [
    SnackItem(
      ...
      price: 569000,
      image: 'assets/images/snacks/combo.png',
      hasPromotion: true,
    ...
    SnackItem(
      ...
      price: 45000,
      image: 'assets/images/snacks/bap.png',
      hasPromotion: false,
      category: 'Bắp',
    ...
    SnackItem(
      ...
      price: 25000,
      image: 'assets/images/snacks/nuoc.png',
      hasPromotion: false,
      category: 'Nước',
        ...
        child: AppBar(
          ...
          title: Column(
            ...
            children: [
              ...
              Text(
                'Cinema 5, ${widget.showDate.HH_mm()}, ${widget.showTime.HH_mm()}',
                style: const TextStyle(
                  color: Colors.grey,
                  fontSize: 14,
                ),
